...
(function() {
    ...
    */
    ...
    jSmart.prototype.loadTemplate=function(tplName,tplString){
        var tree=[]
        if (!tplName){
            throw 'You must specify template name'
        }
        filters = {'pre':jSmart.prototype.filters_global.pre};
        this.cache[tplName]=parse( applyFilter('pre',stripComments(tplString.replace(/\r\n/g,'\n'))), tree);
    }
    jSmart.prototype.render=function(tplName,data){
        if (this.cache[tplName]){
            return this.renderTree(this.cache[tplName],data)
        }
        else {
            throw 'Render error! No such template: '+tplName
        }
    }
    jSmart.prototype.renderTree=function(tree,data){
        blocks = this.blocks;
        ...
        var res = process(tree, this.data);
    ...
    {
        return this.renderTree(this.tree,data);
    };
