...
(function() {
  ...
  window.BJSON = (function() {
    ...
    BJSON.prototype.dontUseLeftBranch = function(iMaxFreq, iOtherFreq, iSymbolCount) {
      var a1, a2, aWeight, b1, b2, k, q, qDeg, r, t, tDeg, _ref, _ref1;
      _ref = this.binDegrees(iSymbolCount - 1), t = _ref[0], k = _ref[1], tDeg = _ref[2];
      _ref1 = this.binDegrees(iSymbolCount), q = _ref1[0], r = _ref1[1], qDeg = _ref1[2];
      aWeight = iSymbolCount - 1;
      a1 = Math.floor(((tDeg - k) * (t + 1) + (iSymbolCount - tDeg + k - 1) * (t + 2)) / (iSymbolCount - 1));
      a2 = iSymbolCount - tDeg + k - 1 ? t + 2 : t + 1;
      b1 = Math.floor(((qDeg - r) * q + (iSymbolCount - qDeg + r) * (q + 1)) / iSymbolCount);
      b2 = iSymbolCount - qDeg + r ? q + 1 : q;
