...
(function() {
  ...
  JAFW.API = (function() {
    ...
    API.prototype.call = function(sSignature, oArgs, fSuccess, fError) {
      var method, module, requestData, _ref;
      _ref = sSignature.split(APP_DELIMITER), module = _ref[0], method = _ref[1];
    ...
    API.prototype.chain = function(oRequests, fSuccess, fError) {
      ...
      oRequests.forEach(function(request) {
        var method, module, _ref;
        _ref = request[1].split(APP_DELIMITER), module = _ref[0], method = _ref[1];
